...
# Note: Debian Trixie has Mapnik 4.0 with plugins in /usr/lib/mapnik/input
RUN sed -i 's|^plugindir=.*|plugindir=/usr/lib/mapnik/input|' /etc/tirex/renderer/mapnik.conf \
